...
class Say {
  ...
  final Widget? person;
  final Size? personSize;
  final EdgeInsetsGeometry? personTextPadding;
  final double? personOutsideOffset;
  final double? personTopOffset;
  ...
  Say({
    ...
    this.person,
    this.personSize,
    this.personTextPadding,
    this.personOutsideOffset,
    this.personTopOffset,
    this.background,
    this.header,
    this.bottom,
    this.speed,
