            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Cut 100 fruits under 1 min to ensure\nthis bro's proper nutrition.",
                  ...
                  Text(
                    'Hold the mouse button and drag fast to slash.\nBombs will stun you and cost 5 cuts.',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.sniglet(
                      fontSize: 21,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        game.overlays.remove('minigame');
                        game.startKitchenMinigame();
                      },
